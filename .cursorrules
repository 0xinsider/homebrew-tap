...
Instructions for AI coding agents working in this repository. This is the official Homebrew tap for the 0xinsider CLI and MCP server.
...
- Formula files are updated by the release script. Bump the version and SHA together; never edit one alone.
